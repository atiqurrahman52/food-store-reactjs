        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="py-10 xl:py-16">
            ...
            <div className="relative">
              ...
              <img
                className="absolute top-[-80px] left-[403px] xl:block hidden"
                src={leaf}
                alt=""
              />
            </div>
            ...
            <button className="bg-white text-primary_3 font-Montserrat font-semibold text-base py-2 xl:py-4 px-10 xl:px-12 rounded xl:rounded-xl">
              Shop now
            </button>
          </div>
          <div className="py-5">
