...
const BlogDetailBanner = () => {
    return (
        <section id="sub_header" className="">
        <div className="sub-header h-[300px] bg-cover bg-center bg-no-repeat hidden md:block">
          <div className="flex flex-col justify-center items-center h-full">
            <h3 className="font-Playfair font-black text-xl md:text-5xl text-text_color mb-[14px]">Blog Details</h3>
        ...
        <div className="sub-header-mobile h-[180px] bg-cover bg-center bg-no-repeat md:hidden">
          <div className="flex flex-col justify-center items-center h-full">
            <h3 className="font-Playfair font-black text-xl md:text-5xl text-text_color mb-5">Blog Details</h3>
            <div className="relative">
